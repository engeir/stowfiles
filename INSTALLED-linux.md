...
apache2 2.4.52-1ubuntu4.8 [Ubuntu/jammy main]
apache2-bin 2.4.52-1ubuntu4.8 [Ubuntu/jammy main]
apache2-data 2.4.52-1ubuntu4.8 [Ubuntu/jammy main]
apache2-utils 2.4.52-1ubuntu4.8 [Ubuntu/jammy main]
...
containerd.io 1.6.28-2 [Docker CE/ stable]
...
gir1.2-mutter-10 42.9-0ubuntu7 [Ubuntu/jammy main]
...
gir1.2-poppler-0.18 22.02.0-2ubuntu0.3 [Ubuntu/jammy main]
...
google-chrome-stable 123.0.6312.122-1 [Google/stable main]
...
libc6-dbg 2.35-0ubuntu3.6 [Ubuntu/jammy main]
...
libcurl3-gnutls:i386 7.81.0-1ubuntu1.16 [Ubuntu/jammy main]
...
libgnutls-dane0 3.7.3-4ubuntu1.4 [Ubuntu/jammy main]
libgnutls-openssl27 3.7.3-4ubuntu1.4 [Ubuntu/jammy main]
libgnutls28-dev 3.7.3-4ubuntu1.4 [Ubuntu/jammy main]
libgnutls30 3.7.3-4ubuntu1.4 [Ubuntu/jammy main]
libgnutls30:i386 3.7.3-4ubuntu1.4 [Ubuntu/jammy main]
libgnutlsxx28 3.7.3-4ubuntu1.4 [Ubuntu/jammy main]
...
libgtk-4-dev 4.6.9+ds-0ubuntu0.22.04.1 [Ubuntu/jammy main]
...
libjavascriptcoregtk-4.1-0 2.42.5-0ubuntu0.22.04.2 [Ubuntu/jammy main]
...
libmutter-10-0 42.9-0ubuntu7 [Ubuntu/jammy main]
...
libnspr4:i386 2:4.35-0ubuntu0.22.04.1 [Ubuntu/jammy main]
...
libnss3 2:3.98-0ubuntu0.22.04.1 [Ubuntu/jammy main]
libnss3-dev 2:3.98-0ubuntu0.22.04.1 [Ubuntu/jammy main]
libnss3:i386 2:3.98-0ubuntu0.22.04.1 [Ubuntu/jammy main]
...
libodbc1 2.3.9-5ubuntu0.1 [Ubuntu/jammy main]
libodbc1:i386 2.3.9-5ubuntu0.1 [Ubuntu/jammy main]
libodbc2 2.3.9-5ubuntu0.1 [Ubuntu/jammy main]
libodbc2:i386 2.3.9-5ubuntu0.1 [Ubuntu/jammy main]
libodbccr2 2.3.9-5ubuntu0.1 [Ubuntu/jammy main]
libodbccr2:i386 2.3.9-5ubuntu0.1 [Ubuntu/jammy main]
...
libperl5.34:i386 5.34.0-3ubuntu1.3 [Ubuntu/jammy main]
...
libpoppler-glib8:i386 22.02.0-2ubuntu0.3 [Ubuntu/jammy main]
libpoppler-qt5-1 22.02.0-2ubuntu0.3 [Ubuntu/jammy universe]
libpoppler118 22.02.0-2ubuntu0.3 [Ubuntu/jammy main]
libpoppler118:i386 22.02.0-2ubuntu0.3 [Ubuntu/jammy main]
...
libwebkit2gtk-4.1-0 2.42.5-0ubuntu0.22.04.2 [Ubuntu/jammy universe]
...
linux-generic 5.15.0.102.99 [Ubuntu/jammy main]
linux-generic-hwe-20.04 5.15.0.102.99 [Ubuntu/jammy main]
linux-generic-hwe-22.04 6.5.0.27.28~22.04.1 [Ubuntu/jammy main]
linux-headers-5.15.0-102 5.15.0-102.112 [Ubuntu/jammy main]
linux-headers-5.15.0-102-generic 5.15.0-102.112 [Ubuntu/jammy main]
...
linux-headers-generic 5.15.0.102.99 [Ubuntu/jammy main]
linux-headers-generic-hwe-22.04 6.5.0.27.28~22.04.1 [Ubuntu/jammy main]
...
linux-image-5.15.0-102-generic 5.15.0-102.112 [Ubuntu/jammy main]
...
linux-image-generic 5.15.0.102.99 [Ubuntu/jammy main]
linux-image-generic-hwe-22.04 6.5.0.27.28~22.04.1 [Ubuntu/jammy main]
linux-libc-dev 5.15.0-102.112 [Ubuntu/jammy main]
linux-modules-5.15.0-102-generic 5.15.0-102.112 [Ubuntu/jammy main]
...
linux-modules-extra-5.15.0-102-generic 5.15.0-102.112 [Ubuntu/jammy main]
...
mutter 42.9-0ubuntu7 [Ubuntu/jammy universe]
mutter-common 42.9-0ubuntu7 [Ubuntu/jammy main]
...
r-cran-boot 1.3-30-1.2204.0 [CRAN/jammy-cran40 ]
...
r-cran-matrix 1.6-5-1.2204.0 [CRAN/jammy-cran40 ]
...
r-cran-survival 3.5-8-1.2204.0 [CRAN/jammy-cran40 ]
...
signal-desktop 7.4.0 [. xenial/xenial main]
...
thorium-browser 122.0.6261.132-1 [local]
...
webkit2gtk-driver 2.42.5-0ubuntu0.22.04.2 [Ubuntu/jammy universe]
...
name: signal-desktop version: 7.4.0
...
package ansible-core 2.16.5, installed using Python 3.12.2
 ...
 - ansible-test
 - ansible-vault
package black 24.3.0, installed using Python 3.12.2
 - black
 - black-primer
 - blackd
...
package pandoc-include 1.3.0, installed using Python 3.12.2
 - pandoc-include
package pdfcropmargins 2.1.1, installed using Python 3.12.2
 - pdf-crop-margins
 - pdfcropmargins
...
Freedesktop Platform                    23.08.15                                23.08
Mesa                                    24.0.4                                  22.08
Mesa (Extra)                            24.0.4                                  22.08-extra
Mesa                                    24.0.4                                  23.08
Mesa (Extra)                            24.0.4                                  23.08-extra
Intel                                                                           22.08
Intel                                                                           23.08
openh264                                2.1.0                                   2.0
