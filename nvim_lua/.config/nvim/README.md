...
This is @engeir's NeoVim config, on NVIM v0.10.0-dev-373+g07883940b (view at [latest
commit](https://github.com/neovim/neovim/tree/07883940b)) installed with the [bob version
