...
This is @engeir's NeoVim config, on NVIM v0.10.0-dev-379+g6661cdf2b (view at [latest
commit](https://github.com/neovim/neovim/tree/6661cdf2b)) installed with the [bob version
