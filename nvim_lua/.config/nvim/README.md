...
This is @engeir's Neovim config, on NVIM v0.10.0-dev-895+g91d8f2ac5 (view at [latest
commit](https://github.com/neovim/neovim/tree/91d8f2ac5)) installed with the [bob version
