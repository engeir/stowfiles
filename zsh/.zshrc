...
export NNN_BMS='b:~/BoxSync/;c:~/.config/;d:~/Downloads/;l:~/.local;n:~/Documents/notes_papers/;o:~/OneDrive/;p:~/programs/;r:~/science/ref/;s:~/bin/;t:~/Documents/teaching/;w:~/Documents/work/'
